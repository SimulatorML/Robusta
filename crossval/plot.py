...
def plot_learning_curve(result: dict,
    ...
    Returns
    -------
    trn_scores, val_scores : Tuple[np.ndarray, np.ndarray]
...
def plot_roc_auc(results: Union[list, dict],
    ...
    labels : Optional[List]
        A list of strings to label the ROC curve for each classifier. If None, the label for each
