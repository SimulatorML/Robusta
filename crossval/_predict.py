...
def _rank_pred(pred: Union[pd.DataFrame, pd.Series]) -> Union[pd.DataFrame, pd.Series]:
    ...
    Returns
    -------
    rank : Union[pd.DataFrame, pd.Series]
...
def _soft_vote(pred: Union[pd.DataFrame, pd.Series]) -> Union[pd.Dataframe, Any]:
    """
...
def _hard_vote(pred: Union[pd.DataFrame, pd.Series]) -> Union[pd.Dataframe, Any]:
    """
