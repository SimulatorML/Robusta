...
def split_cv_groups(results: Dict[str, Any],
    ...
    ----------
    results : dict
        A dictionary mapping string keys to dictionaries that contain cross-validation results. Each dictionary must
        contain a key 'cv' that maps to a scikit-learn BaseCrossValidator object. Other keys can be present but are
...
def check_folds(results: Dict[str, Any],
    ...
    Returns
    -------
    idx_abc : Dict[int, List[int]]
        A dictionary mapping the index of each cross-validation scheme to a list of the indices of the
...
def rating_table(results: Dict[str, Dict[str, float]],
    ...
    results: Dict[str, Dict[str, float]]
        A dictionary containing the performance metrics for different models. The keys of the dictionary are
        the unique IDs of the models, and the values are dictionaries containing the following keys:
