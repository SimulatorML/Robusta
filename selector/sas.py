...
def perturb_subset(subset: pd.Series,
    ...
    ----------
    subset : Series
        The subset of features to be perturbed.
    step : int
        The number of features to be randomly removed and added.
    random_state : Optional[int]
        Seed to ensure reproducibility of random number generation.
    drop_attrs : Optional[List[str]]
        Attributes to drop from the resulting perturbed subset.
...
class SAS(_WrappedSelector):
    ...
    def min_step_(self) -> float:
        ...
        -------
        min_step : float
            The validated minimum fraction of features to remove at each iteration.
        """
    ...
    def max_step_(self):
        ...
        -------
        max_step : float
            The validated maximum fraction of features to remove at each iteration.
        """
