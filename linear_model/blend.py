...
def check_avg_type(avg_type: str) -> str:
    ...
    ----------
    avg_type : str
        The type of average to be checked

    Returns
    -------
    str:
        The full name of the <avg_type>

    Raises
    ------
    ValueError:
        If the given <avg_type> is not a valid value
    """
...
class _BaseBlend(LinearModel):
    ...
    **opt_kws : dict, optional
    ...
    def score(self, X: pd.DataFrame, y: pd.Series) -> float:
        ...
        ----------
        X : pd.DataFrame
            The input data to calculate the score.
        y: pd.Series
            The target variable.
        ...
        -------
        float:
            The score of the estimator on the input data.
