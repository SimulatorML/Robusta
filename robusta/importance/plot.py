...
def plot_importance(imps: List[pd.Series],
    ...
    Args:
    - imps: list of pandas Series, each containing feature importances.
    - features: list of str, names of features to be plotted.
                If None, the top k_top features will be plotted.
    - k_top: int, number of top features to plot.
