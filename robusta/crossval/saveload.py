...
def save_result(result: Dict[str, Any],
    ...
    Args:
        result (dict): A dictionary containing the model's results.
        idx (int): Index number of the model.
        name (str): Name of the model.
        make_submit (bool, optional): Whether to create a submission file or not. Defaults to True.
        force_rewrite (bool, optional): Whether to overwrite existing files with the same name. Defaults to False.
        result_path (str, optional): Path to the directory where the result file will be saved. Defaults to './results/'.
        submit_path (str, optional): Path to the directory where the submission file will be saved. Defaults to './submits/'.
        silent_mode (str, optional): A mode that can be applied to the predictions before saving the submission file.
                                     Defaults to None.
        **kwargs: Additional key-value arguments that will be added to the result dictionary.
...
def load_result(idx: int,
    ...
    Args:
        idx (int): The index of the result to load.
        result_path (str): The directory containing the joblib files. Default is './results/'.

    Returns:
        dict or None: The result dictionary loaded from the joblib file, with the 'idx' and 'model_name' keys added,
...
def find_result(idx: int,
    ...
    Args:
        idx (int): The index of the result to search for.
        result_path (str): The directory containing the joblib files. Default is './results/'.

    Returns:
        str or None: The file path of the joblib file containing the result with the given index,
                     or None if no matching file was found.
    """
...
def list_results(result_path: str = './results/') -> List[str]:
    ...
    Returns:
        list: A list of joblib file names in the given directory.
    """
