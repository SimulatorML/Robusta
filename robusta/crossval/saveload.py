...
def load_result(
    idx: int, result_path: str = "./results/"
) -> Optional[Dict[str, Union[int, str, object]]]:
    """
...
def find_result(idx: int, result_path: str = "./results/") -> Optional[str]:
    """
    ...
    -------
    str or None:
        The file path of the joblib file containing the result with the given index, or None if no matching
        file was found.
    """
