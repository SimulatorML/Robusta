...
def _avg_preds(preds: List[pd.DataFrame],
    ...
    Args:
        preds (list[pd.DataFrame]): A list of DataFrames of model predictions.
        avg (Callable): A callable function to apply to the predictions for averaging.
        X (pd.DataFrame): A DataFrame of input features.
        y (pd.Series): A Series of target values.
        index (pd.Index, optional): An optional index of rows to include in the output. Defaults to None.

    Returns:
        pd.Series: A Series of averaged model predictions.
    """
...
def _drop_zero_class(pred: Union[pd.DataFrame, pd.Series],
    ...
    Args:
        pred (Union[pd.DataFrame, pd.Series]): A DataFrame or Series of model predictions.
        y (pd.Series): A Series of target values.

    Returns:
        Union[pd.DataFrame, pd.Series]: The input DataFrame or Series with zero-class predictions removed.
    """
...
def _pass_pred(pred: Union[pd.DataFrame, pd.Series]) -> Union[pd.DataFrame, pd.Series]:
    ...
    Returns:
        Union[pd.DataFrame, pd.Series]: The input DataFrame or Series of predictions.
    """
...
def _mean_pred(pred: Union[pd.DataFrame, pd.Series]) -> Union[pd.DataFrame, pd.Series]:
    ...
    Returns:
        Union[pd.DataFrame, pd.Series]: The mean prediction across all models.
    """
...
def _rank_pred(pred: Union[pd.DataFrame, pd.Series]) -> Union[pd.DataFrame, pd.Series]:
    ...
    Returns:
        Union[pd.DataFrame, pd.Series]: The rank-based prediction across all models.
    """
...
def _soft_vote(pred: Union[pd.DataFrame, pd.Series]) -> DataFrame | Any:
    ...
    Returns:
        Union[pd.Series]: The soft voting prediction across all models.
    """
...
def _hard_vote(pred: Union[pd.DataFrame, pd.Series]) -> DataFrame | Any:
    ...
    Returns:
        Union[pd.Series]: The hard voting prediction across all models.
    """
...
def _multioutput_vote(pred: pd.DataFrame,
    ...
    Args:
        pred (pd.DataFrame): A DataFrame of multi-output model predictions.
        vote (Callable): The voting function to apply to each target.

    Returns:
        pd.DataFrame: The prediction for each target after applying the voting function.
    """
...
def _multioutput_pred(pred: pd.DataFrame,
    ...
    Args:
        pred (pd.DataFrame): A DataFrame of multi-output model predictions.
        avg (Callable): The averaging function to apply to each target.

    Returns:
        pd.DataFrame: The prediction for each target after applying the averaging function.
    """
