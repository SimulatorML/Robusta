...
class StackingTransformer(_BaseComposition, TransformerMixin):
    ...
    def fit(self,
        ...
        Args:
            X (pandas.DataFrame): Input training data.
            y (pandas.Series): Training labels.
            groups (pandas.Series, optional): Group labels for cross-validation. Default is None.

        Returns:
            StackingTransformer: The fitted stacked transformer object.
        """
    ...
    def _fit_1st_layer(self,
        ...
        Args:
            X (pandas.DataFrame): Input training data.
            y (pandas.Series): Training labels.
            groups (pandas.Series): Group labels for cross-validation.
    ...
    def _save_train(self,
        ...
        Args:
            ...
            y: A pandas Series containing the training labels.
    ...
    def _is_train(self,
        ...
        Args:
            X: A pandas DataFrame to be checked.
    ...
    def _transform(self,
        ...
        Args:
            X: A pandas DataFrame containing the test data.
    ...
    def set_params(self,
        ...
        Args:
            **params: A dictionary containing the hyperparameters to be set.
    ...
    def get_params(self,
        ...
        Args:
            deep: A boolean indicating whether to get the hyperparameters of the base estimators as well.
...
def _check_estimator_names(estimators: List[BaseEstimator]):
    """
    ...
    Raises:
    -------
    ValueError: If the estimator names are not unique.
