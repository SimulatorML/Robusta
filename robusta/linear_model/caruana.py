...
class _BaseCaruana(LinearModel):
    ...
    def score(self,
        ...
        Args:
            X (pd.DataFrame): Features data for prediction.
            y (pd.Series): Target data for prediction.

        Returns:
            float: The score of the blended model on the given data.
        """
    ...
    def _blend(self,
        ...
        Returns:
            np.ndarray: The predicted values of the blended model on the given data.
        """
    ...
    def coef_(self) -> np.ndarray:
        if self.weights_.any():
            ...
            Returns:
                np.ndarray: The weights of each model in the blend.
            """
    ...
    def intercept_(self) -> float:
        ...
        Returns:
            float: The intercept value of the blended model.
        """
