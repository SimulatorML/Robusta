...
class Categorizer(BaseEstimator, TransformerMixin):
    ...
    Attributes:
        transformers (dict): A dictionary mapping column names to the fitted Categorizer1D transformers.
    """
    def __init__(self):
        self.transformers = None
    ...
    def fit(self,
        ...
        Parameters:
            X (pandas.DataFrame): The input DataFrame to fit the transformers on.
    ...
    def transform(self,
                  X: pd.DataFrame) -> pd.DataFrame:
        """T
        ransform the input DataFrame by applying the fitted Categorizer1D transformers.

        Parameters:
            X (pandas.DataFrame): The input DataFrame to transform.

        Returns:
            Xt (pandas.DataFrame): The transformed DataFrame.
        """
...
class ThermometerEncoder1D(BaseEstimator, TransformerMixin):
    ...
    def inverse_transform(self,
        ...
        # Compute the original categorical variable by counting the number of 1s in each row and mapping to the category names
...
class ThermometerEncoder(ThermometerEncoder1D):
    ...
    def transform(self,
        ...
        Returns
        -------
        pandas DataFrame : pandas DataFrame, shape [n_samples, n_encoded_features]
    ...
    def inverse_transform(self,
        ...
        Returns
        -------
        pandas DataFrame : pandas DataFrame, shape [n_samples, n_features]
            The transformed data.
        """
