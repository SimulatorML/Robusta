...
def _smoothed_likelihood(x: pd.Series,
    ...
    Parameters:
        x (pd.Series): A pandas series representing the feature.
        y (pd.Series): A pandas series representing the target variable.
        smoothing (float): A float representing the smoothing factor.
        min_samples_leaf (int, optional): The minimum number of samples required to consider a split. Defaults to 1.

    Returns:
        pd.Series: A pandas series containing the smoothed likelihoods.
    """
...
class EncoderCV(BaseEstimator):
    ...
    def _transform(self,
        ...
        Parameters:
            encoder (object): An encoder object with a `transform` method to encode the data.
            X (pandas.DataFrame): The data to encode.
    ...
    def _transform_train(self,
        ...
        Parameters:
            encoder (object): An encoder object with a `transform` method to encode the data.
            X (pandas.DataFrame): The data to encode.
            oof (numpy.ndarray): An array of indices for the out-of-fold data.
    ...
    def _fit_data(self,
        ...
        Parameters:
            ...
            y (pandas.Series): The target values for the training data.
    ...
    def _get_folds(self,
        ...
        Parameters:
            X (pandas.DataFrame): The data to split into folds.
    ...
    def _is_train(self,
        ...
        Parameters:
            X (pandas.DataFrame): The data to check.
