...
def _plot_subset(fs: object, **kwargs) -> Tuple:
    ...
    ----------
    fs : object
        Feature selection object with a trials_ attribute containing a list of namedtuples.
    **kwargs: dict
        Additional arguments to be passed to the ax.plot() function.
...
def _plot_progress(fs: Any, **kwargs: Dict[str, Any]) -> tuple:
    ...
    ----------
    fs : Any
        A hyperparameter optimization algorithm object.
    **kwargs : Dict[str, Any]
    ...
    -------
    tuple:
        A tuple containing a `matplotlib` figure and axis object.
    """
