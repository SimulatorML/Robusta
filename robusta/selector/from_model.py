...
def _check_max_features(importances: pd.Series,
                        max_features: Union[int, float, None]):
    """"
...
def _check_threshold(importances: pd.Series,
    ...
    threshold (str, float, None): The threshold value.

    Returns:
        float: The interpreted threshold value.

    Raises:
        ValueError: If threshold argument is not recognized.
    """
