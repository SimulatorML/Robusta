...
class _WrappedGroupSelector:
    ...
    def _get_importance(self,
        ...
        Args:
            subset (object): A feature subset object.
            result (dict): A dictionary containing the feature importance scores and their corresponding groups.

        Returns:
            object: The updated feature subset object with the 'importance' and 'importance_std' attributes set.
        """
    ...
    def _set_features(self,
        ...
        Args:
            X (pandas.DataFrame): The input data frame containing the features and their groups.
        """
