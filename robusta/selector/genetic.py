...
def cxUniform(ind1: base.Toolbox,
    ...
    Args:
        ind1 (base.Toolbox): The first individual to be crossed.
        ind2 (base.Toolbox): The second individual to be crossed.
        indpb (float, optional): The probability of an attribute being swapped between the two individuals. Defaults to 0.5.
        random_state (int, optional): Seed for the random number generator. Defaults to None.
        drop_attrs (list, optional): A list of attributes to be dropped from the children. Defaults to ['score'].

    Returns:
        Tuple[base.Toolbox, base.Toolbox]: A tuple containing the two child individuals.
...
def mutSubset(ind: base.Toolbox,
    ...
    indpb (float): The probability of each feature to be mutated.
    random_state (int, optional): Seed for the random number generator.
    drop_attrs (list, optional): List of attributes to be dropped from the mutated individual.
