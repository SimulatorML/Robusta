...
class ExhaustiveSelector(_WrappedSelector):
    ...
    def fit(self,
        ...
        Args:
            X (pandas.DataFrame): The input data frame containing the features.
            y (pandas.Series): The target variable.
            groups (pandas.Series): The groups of the features.
    ...
    def _fit_start(self,
        ...
        Args:
            X (pandas.DataFrame): The input data frame containing the features.
            partial (bool): A flag indicating whether the fitting is partial or not.
    ...
    def get_subset(self) -> None:
        ...
        Returns:
        - None - The best subset found by the model.
        """
