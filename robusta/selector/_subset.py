...
class FeatureSubset:
    ...
    ----------
    features:
        A numpy array or pandas Index containing all features.
    subset:
        A list or tuple of indices or feature names to be included in the subset. Defaults to None.
    mask:
        A boolean list or numpy array indicating which features are selected. Defaults to None.
    group:
        A boolean flag to indicate if the features represent groups (e.g. multi-level columns). Defaults to False.

    Raises:
    ------
    ValueError:
        If both <subset> and <mask> are set.
    AssertionError:
    ...
    def set_subset(self, subset: Sequence[Union[int, str]]) -> "FeatureSubset":
        ...
        Parameters
        ----------
        subset : Sequence[Union[int, str]]
            A list or tuple of indices or feature names to be included in the subset.

        Raises
        ------
        AssertionError:
            If any values in <subset> are not in <features>, or if <subset> values are not unique.
    ...
    def set_mask(self, mask: np.ndarray) -> "FeatureSubset":
        ...
        ----------
        mask : ndarray
            A boolean 1D numpy array with the same length as self.features.
    ...
    def sample(
        ...
        ----------
        size : int
            The size of the subset to sample. If None, a random subset with a random size is returned.
        random_state : int
    ...
    def remove(self, *features, copy: bool = True) -> "FeatureSubset":
        ...
        ----------
        features : List[str]
            The feature names to remove from the subset.
        copy : bool
            If True, return a new FeatureSelector object. If False, modify the current object in place.
    ...
    def append(self, *features, copy: bool = True) -> "FeatureSubset":
        ...
        ----------
        features : List[str]
            The feature names to add to the subset.
        copy : bool
            If True, return a new FeatureSelector object. If False, modify the current object in place.
    ...
    def n_features(self) -> int:
        ...
        -------
        num_features : int
            The number of features in the original feature set.
        """
    ...
    def shape(self) -> Tuple[int, ...]:
        ...
        -------
        shape : tuple
            The shape of the selected subset as a tuple.
        """
        return (self.n_selected,)
