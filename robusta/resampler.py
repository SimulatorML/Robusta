...
class PandasSampler:
    ...
    def fit_resample(self,
        ...
        Args:
            X: A pandas DataFrame of shape (n_samples, n_features) containing the input data.
            y: A pandas Series of shape (n_samples,) containing the target labels.
        ...
        Raises:
            TypeError: If X is not a pandas DataFrame or if y is not a pandas Series or DataFrame.
        """
